...
+ (NSString*) randomFullName
{
    ...
    NSArray *middleNames = @[@"Thị", @"Văn", @"Hồng", @"Hải", @"Hữu", @"Minh", @"Long", @"Dũng", @"Lan", @"Phong", @"Mạnh"];
    NSArray *lastNames = @[@"Lan", @"Cường", @"Dũng", @"Chung", @"Toàn", @"Đông", @"Long", @"Thanh", @"Hương", @"Trà", @"Hạnh"];
...
+ (Staff*) randomStaff  {
    ...
    switch (staffType) {
        case 0:
            ...
            break;
        case 1:
            return [[Manager alloc] initWithName:[Randomizer randomFullName] andLevel:arc4random() % 7];
        case 2:
